...
CREATE TABLE IF NOT EXISTS relay_attempts (
    ...
    last_seen_at TIMESTAMP WITH TIME ZONE DEFAULT CURRENT_TIMESTAMP, -- will default to CURRENT_TIMESTAMP
    PRIMARY KEY (relay_id, txn_id)
);

-- Fix typo in relay_attempts last_seen_at: DEFAULT TIME_STAMP should be DEFAULT CURRENT_TIMESTAMP
ALTER TABLE relay_attempts ALTER COLUMN last_seen_at SET DEFAULT CURRENT_TIMESTAMP;
